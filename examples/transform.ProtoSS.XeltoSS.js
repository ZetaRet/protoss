...
window.package("zetaret.global.packages.examples.xeltoss").internal(
	function ClassD() {
		...
		var m = {};
		m.behaviorAA = function() {
			return o.a * o.a * o.d + o.dd;
		};
		m.behaviorD = function() {
			return o.dd * o.d;
		};
		m._constructor = function() {
...
ProtoSS.headerSuperList2.push([zetaret.global.packages.examples.xeltoss.ClassD, ["zetaret.global.packages.examples.xeltoss::ClassA",
	"zetaret.global.packages.examples.xeltoss::ClassB", "zetaret.global.packages.examples.xeltoss::ClassC"
]]);
