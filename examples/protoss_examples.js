function superlistdummy0(a1, a2) {
	...
	m.customf = function() {
		return o;
	}; // always use o instead of this
	m.customf1 = function() {
		return o.val;
	}; // refer to o instead of this
	m.setval = function(v) {
...
function superlistdummy1(aa) {
	...
	var m = {}; // set methods to m (member map), also to o if you want to tern
	// them
	m.customf1 = function() {
		return o.val + 1;
	};
...
function superlistdummy2(aa) {
	...
	m.customf2 = function() {
		return o.a;
	}; // overloads customf2#superlistdummy1
	o.superize(a, m, true, true, true); // required
	return o;
}
...
ss.getSupers(); // return [ZetaRet_SuperList_XXX13XXX, superlistdummy1, level1,
// level2, level3, level4, superlistdummy2]
...
s.callSuper2('customf1'); // return 2 from super customf1#superlistdummy1
// attached to ZetaRet_List_XXX13XXX
s.callProto(superlistdummy1, 'customf1'); // return 2 from
// customf1#superlistdummy1
s.basef(); // return 0 from basef#superlistdummy1 attached to superlistdummy0
s.callSuper('basef'); // return 1 from basef#level2
s.callSuper2('basef'); // return 0 from basef#superlistdummy1 attached to
// ZetaRet_List_XXX13XXX
